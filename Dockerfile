...
RUN apt-get update && \
    apt-get install -o DPkg::Options::="--force-confold" -y git libfreetype6-dev libjpeg62-turbo-dev libpng-dev curl zip openssl libpq-dev libcurl4-openssl-dev libsodium-dev libzip-dev libicu-dev libssl-dev locales nginx wget sudo && \
